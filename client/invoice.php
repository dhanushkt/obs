...
<head>''
	...
	<!-- Site Title -->
	<title>AlphaSystems - Invoice page</title>
	<!-- Favicon Icon -->
...
<body>
	<div class="container">
				...
				<div class="col-6">
					<table class="invoice-info">
						...
						<!--- <tr>
						 ...
						 <td><input disabled class="text" value="<?php //echo $getinfo['cemail']; ?>"></td>
						</tr>
						<tr>
				...
				<div class="col-6">
					<table class="pull-right invoice-info">
						<tr>
							...
							<td><textbox disabled><?php echo $getinfo['bill_id']; ?></textbox></td>
						</tr>
						<tr>
			...
			<div class="items">
				<table>
					...
					<tr>
						...
						<td colspan="2">
							<span id="subtotal"><?php if($sub_total!=0){ echo $sub_total; } ?></span>
						</td>
					</tr>
					<tr>
						<td colspan="3" class="blank"></td>
					...
					<tr>
						...
						<td colspan="2">
							<span id="total"> <?php if($getinfo['total_amt']!='0.00'){ echo $getinfo['total_amt'];  } else { if($sub_total!=0) { echo $sub_total + $total_tax; } } ?></span>
						</td>
					</tr>
					<tr>
						<td colspan="3" class="blank"></td>
						...
						<td colspan="2">
							...
							<span id="dbamtp"><?php echo $getinfo['amt_paid']; ?></span>
							<?php } else { ?>
					...
					<tr>
						...
						<td colspan="2">
							<span id="due"><?php if($getinfo['amt_due']!='0.00'){ echo $getinfo['amt_due']; } ?></span>
						</td>
					</tr>
		...
		<div class="invoice-ftr">
			<p>Note</p>
			<textarea placeholder="THIS IS A COMPUTER GENERATED INVOICE"></textarea>
			<center><h6>THANK YOU FOR SHOPPING</h6></center>
		</div>
</div>
