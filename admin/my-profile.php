...
$query="SELECT aid, aemail, amob, apassword FROM admin WHERE aname='$ausername'";
...
if(isset($_POST['updateprofile']))
{
	...
	$uquery="UPDATE admin SET aname='$username', aemail='$email', amob='$mob' WHERE a_id='$id'";
	$uresult = mysqli_query($connection, $uquery);
	if($uresult)
	{
		$squery="SELECT aname, aemail, amob FROM admin WHERE aid='$id'";
...
if(isset($_POST['changepw']))
{
	...
	if($oldpw==$row["apassword"])
	{
		...
		$pwquery="UPDATE admin SET apassword='$npw' WHERE aname='$ausername'";
                             ...
                             <form data-toggle="validator" method="post">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                    ...
                                    <input pattern="[0-9]*" minlength="10" maxlength="11" type="tel" name="amob" class="form-control" id="inputMobile" placeholder="Mobile Number" value="<?php echo $row["amob"]; ?>" data-error="This mobile number is invalid" required>
                                    <div class="help-block with-errors"></div>
                                </div>
