            ...
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" method="post">
                    ...
                    <a href="javascript:void(0)" class="text-center db">
                        <img src="../plugins/images/is-logo-full.png" width="200" alt="Home" />
                        <br />
                        <!-- <img src="../plugins/images/eliteadmin-text-dark.png" alt="Home" /> -->
                    </a>
                    <div class="form-group m-t-40">
                        <div class="col-xs-12">
                            <input autofocus tabindex="1" class="form-control" type="text" name="username" required placeholder="Username or Email" value="<?php if (isset($username) & !empty($username)) {
                                                                                                                                                                echo $username;
                                                                                                                                                            } ?>">
                        </div>
                    </div>
